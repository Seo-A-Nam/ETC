...
var fileDescriptor_a0b84a42fa06f626 = []byte{
	...
	0x5c, 0x9a, 0x53, 0x02, 0x55, 0x0c, 0xe5, 0x19, 0x25, 0x70, 0x71, 0x39, 0xa6, 0xa4, 0x04, 0x43,
	0x6c, 0x11, 0x52, 0xe3, 0x62, 0x76, 0x4c, 0x49, 0x11, 0xe2, 0x83, 0x58, 0xa7, 0x07, 0xb5, 0x44,
	0x8a, 0x1f, 0xce, 0x87, 0x9a, 0xa6, 0xc5, 0xc5, 0xee, 0x5b, 0x5a, 0x92, 0x59, 0x90, 0x53, 0x49,
	0x50, 0x6d, 0x12, 0x1b, 0x98, 0x6f, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0xd3, 0x83, 0x71, 0xb4,
	0xcb, 0x00, 0x00, 0x00,
}
...
type AddServiceClient interface {
	...
	Mutiply(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *addServiceClient) Mutiply(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/proto.AddService/Mutiply", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AddServiceServer interface {
	...
	Mutiply(context.Context, *Request) (*Response, error)
}
...
func (*UnimplementedAddServiceServer) Mutiply(ctx context.Context, req *Request) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Mutiply not implemented")
}
...
func _AddService_Mutiply_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AddServiceServer).Mutiply(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.AddService/Mutiply",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AddServiceServer).Mutiply(ctx, req.(*Request))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _AddService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Mutiply",
			Handler:    _AddService_Mutiply_Handler,
		},
	},
